...
function formatRating(cellValue, options, rowObject) {
	...
	var color = (parseInt(cellValue) > 0) ? "<img src='//cdn.jsdelivr.net/gh/sheyi/img/higrid_demo_images/up.gif'><span style='color:red'>" : "<img src='//cdn.jsdelivr.net/gh/sheyi/img/higrid_demo_images/down.gif'><span style='color:green'>";
